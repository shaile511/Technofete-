   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<a href="javascript:void(0);" class="dtp-select-month-before"><i class="zmdi zmdi-chevron-left zmdi-hc-2x"></i></a>' +
                         '</div>' +
                         '<div class="dtp-actual-month p80">MAR</div>' +
                         '<div class="right center p10">' +
                         '<a href="javascript:void(0);" class="dtp-select-month-after"><i class="zmdi zmdi-chevron-right zmdi-hc-2x"></i></a>' +
                         '</div>' +
                         ...
                         '<div>' +
                         '<div class="left center p10">' +
                         '<a href="javascript:void(0);" class="dtp-select-year-before"><i class="zmdi zmdi-chevron-left zmdi-hc-2x"></i></a>' +
                         '</div>' +
                         '<div class="dtp-actual-year p80">2014</div>' +
                         '<div class="right center p10">' +
                         '<a href="javascript:void(0);" class="dtp-select-year-after"><i class="zmdi zmdi-chevron-right zmdi-hc-2x"></i></a>' +
                         '</div>' +
                         '<div class="clearfix"></div>' +
                         '</div>' +
                         '</div>' +
